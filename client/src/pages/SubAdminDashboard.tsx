      ...
      <div className="space-y-6">
        ...
        <div className="mt-12 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          <div className="flex flex-wrap gap-3">
            <Link to="/subadmin/tenants" className="px-4 py-2.5 bg-accent-wash text-accent border border-accent-soft rounded-xl text-sm font-semibold hover:bg-accent-wash transition-all">
              Manage Tenants
            </Link>
            <Link to="/subadmin/quizzes" className="px-4 py-2.5 bg-accent-wash text-accent border border-accent-soft rounded-xl text-sm font-semibold hover:bg-accent-wash transition-all">
              View Quizzes
            </Link>
            <Link to="/subadmin/logs" className="px-4 py-2.5 bg-accent-wash text-accent border border-accent-soft rounded-xl text-sm font-semibold hover:bg-accent-wash transition-all">
              Activity Logs
            </Link>
          </div>
        </div>
