...
const en = {
  ...
  'live.lookUp': 'Look up',
  'live.lookUpBody': 'The question is on the big screen. Pick your answer here.',
...
const hi: Dictionary = {
  ...
  'live.lookUp': 'ऊपर देखें',
  'live.lookUpBody': 'प्रश्न बड़ी स्क्रीन पर है। उत्तर यहाँ चुनें।',
  'live.results': 'परिणाम',
...
const mr: Dictionary = {
  ...
  'hw.eyebrow': 'गृहपाठ',
  'hw.progress': 'प्रश्न {n} / {total}',
  'hw.due': 'शेवटची वेळ {when}',
  'hw.oneTry': 'प्रत्येक प्रश्नासाठी एकच संधी — पाठवण्यापूर्वी तपासा.',
  'hw.rankHint': 'बाणांनी हे योग्य क्रमाने लावा.',
  'hw.doneTitle': 'सर्व पूर्ण झाले',
  'hw.doneBody': 'तुमची उत्तरे जमा झाली. तुम्ही कसे केले ते तुमच्या शिक्षकांना दिसेल.',
  'hw.score': 'तुम्हाला {score} गुण मिळाले.',
  'hw.closed': 'हा गृहपाठ सध्या खुला नाही.',
};
...
const bn: Dictionary = {
  ...
  'hw.eyebrow': 'বাড়ির কাজ',
  'hw.progress': 'প্রশ্ন {n} / {total}',
  'hw.due': 'শেষ সময় {when}',
  'hw.oneTry': 'প্রতিটি প্রশ্নে একবারই সুযোগ — পাঠানোর আগে দেখে নিন।',
  'hw.rankHint': 'তীর দিয়ে এগুলো সঠিক ক্রমে সাজান।',
  'hw.doneTitle': 'সব শেষ',
  'hw.doneBody': 'আপনার উত্তর জমা হয়েছে। আপনি কেমন করলেন, আপনার শিক্ষক দেখতে পাবেন।',
  'hw.score': 'আপনি {score} পেয়েছেন।',
  'hw.closed': 'এই বাড়ির কাজ এখন খোলা নেই।',
};
...
const ta: Dictionary = {
  ...
  'hw.eyebrow': 'வீட்டுப்பாடம்',
  'hw.progress': 'கேள்வி {n} / {total}',
  'hw.due': 'கடைசி நேரம் {when}',
  'hw.oneTry': 'ஒவ்வொரு கேள்விக்கும் ஒரே வாய்ப்பு — அனுப்பும் முன் சரிபார்க்கவும்.',
  'hw.rankHint': 'அம்புகளைப் பயன்படுத்தி இவற்றை வரிசைப்படுத்தவும்.',
  'hw.doneTitle': 'எல்லாம் முடிந்தது',
  'hw.doneBody': 'உங்கள் பதில்கள் சமர்ப்பிக்கப்பட்டன. நீங்கள் எப்படிச் செய்தீர்கள் என்பதை உங்கள் ஆசிரியர் பார்ப்பார்.',
  'hw.score': 'நீங்கள் {score} மதிப்பெண் பெற்றீர்கள்.',
  'hw.closed': 'இந்த வீட்டுப்பாடம் இப்போது திறந்திருக்கவில்லை.',
};
...
const te: Dictionary = {
  ...
  'hw.eyebrow': 'హోంవర్క్',
  'hw.progress': 'ప్రశ్న {n} / {total}',
  'hw.due': 'చివరి సమయం {when}',
  'hw.oneTry': 'ప్రతి ప్రశ్నకు ఒకే అవకాశం — పంపే ముందు చూసుకోండి.',
  'hw.rankHint': 'బాణాలతో వీటిని సరైన క్రమంలో అమర్చండి.',
  'hw.doneTitle': 'అన్నీ పూర్తయ్యాయి',
  'hw.doneBody': 'మీ సమాధానాలు సమర్పించబడ్డాయి. మీరు ఎలా చేశారో మీ ఉపాధ్యాయులు చూస్తారు.',
  'hw.score': 'మీకు {score} మార్కులు వచ్చాయి.',
  'hw.closed': 'ఈ హోంవర్క్ ఇప్పుడు తెరిచి లేదు.',
};
...
const gu: Dictionary = {
  ...
  'hw.eyebrow': 'ગૃહકાર્ય',
  'hw.progress': 'પ્રશ્ન {n} / {total}',
  'hw.due': 'છેલ્લો સમય {when}',
  'hw.oneTry': 'દરેક પ્રશ્ન માટે એક જ તક — મોકલતા પહેલાં તપાસો.',
  'hw.rankHint': 'તીરથી આને સાચા ક્રમમાં ગોઠવો.',
  'hw.doneTitle': 'બધું પૂરું થયું',
  'hw.doneBody': 'તમારા જવાબો જમા થઈ ગયા. તમે કેવું કર્યું તે તમારા શિક્ષક જોશે.',
  'hw.score': 'તમને {score} ગુણ મળ્યા.',
  'hw.closed': 'આ ગૃહકાર્ય અત્યારે ખુલ્લું નથી.',
};
...
const kn: Dictionary = {
  ...
  'hw.eyebrow': 'ಮನೆಗೆಲಸ',
  'hw.progress': 'ಪ್ರಶ್ನೆ {n} / {total}',
  'hw.due': 'ಕೊನೆಯ ಸಮಯ {when}',
  'hw.oneTry': 'ಪ್ರತಿ ಪ್ರಶ್ನೆಗೆ ಒಂದೇ ಅವಕಾಶ — ಕಳುಹಿಸುವ ಮೊದಲು ಪರಿಶೀಲಿಸಿ.',
  'hw.rankHint': 'ಬಾಣಗಳಿಂದ ಇವುಗಳನ್ನು ಸರಿಯಾದ ಕ್ರಮದಲ್ಲಿ ಜೋಡಿಸಿ.',
  'hw.doneTitle': 'ಎಲ್ಲಾ ಮುಗಿಯಿತು',
  'hw.doneBody': 'ನಿಮ್ಮ ಉತ್ತರಗಳನ್ನು ಸಲ್ಲಿಸಲಾಗಿದೆ. ನೀವು ಹೇಗೆ ಮಾಡಿದಿರಿ ಎಂದು ನಿಮ್ಮ ಶಿಕ್ಷಕರು ನೋಡುತ್ತಾರೆ.',
  'hw.score': 'ನಿಮಗೆ {score} ಅಂಕಗಳು ಬಂದಿವೆ.',
  'hw.closed': 'ಈ ಮನೆಗೆಲಸ ಈಗ ತೆರೆದಿಲ್ಲ.',
};
